        ...
        for i, image in enumerate(images):
            ...
            try:
                ...
                try:
                    ...
                    with open("logo@BROKYLIN_THE_KING_OF_DARKNESS_BOT.jpg", "wb+") as f:
                        f.write(r)
                    count += 1
            except:
                pass
...
async def logogen(client, message):
    ...
    try:
        ...
        typeo = "name"
        await pablo.edit(
            "Give name and type for logo Idiot. like `/logogen King Of Darkness:Robot`"
        )
    name = lmao[0]
    mainne(name, typeo)
    pate = "logo@BROKYLIN_THE_KING_OF_DARKNESS_BOT.jpg"
